...
train_dataset,test_dataset,num_classes,num_training_samples = input_dataset("cifar10","../DUBN_cifar/cifar10/","aggre_label", "../data/CIFAR-10_human.pt",True,only_wrong=True )
