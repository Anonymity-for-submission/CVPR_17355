...
#from models.resnet_DuBN import DualBatchNorm2d
from models.resnet_ThBN import DualBatchNorm3d
...
class BasicBlock_DuBN(nn.Module):
    ...
    def __init__(self, in_planes, out_planes, stride, drop_rate=0.0, ibn=None):
        ...
        self.bn1 = DualBatchNorm3d(in_planes)
...
class WideResNet_DuBN(nn.Module):
    ...
    def __init__(self, depth, num_classes=10, widen_factor=1, drop_rate=0.0, init_stride=1):
        ...
        self.bn1 = DualBatchNorm3d(n_channels[3])
...
def WRN40_DuBN(num_classes=10, widen_factor=2, init_stride=1):
    return WideResNet_DuBN(40, num_classes=num_classes, widen_factor=widen_factor, init_stride=init_stride)
