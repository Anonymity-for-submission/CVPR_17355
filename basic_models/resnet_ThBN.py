...
class DualBatchNorm3d(nn.Module):
    def __init__(self, num_features):
        super(DualBatchNorm3d, self).__init__()
        self.bn = nn.ModuleList([nn.BatchNorm2d(num_features), nn.BatchNorm2d(num_features), nn.BatchNorm2d(num_features)])
...
def ResNet18_ThBN(num_classes=10, init_stride=1):
    return ResNet_ThBN(BasicBlock_DuBN, [2, 2, 2, 2], num_classes=num_classes, init_stride=init_stride)

def ResNet50_ThBN(num_classes=10, init_stride=1):
    return ResNet_ThBN(Bottleneck_ThBN, [3, 4, 6, 3], num_classes=num_classes, init_stride=init_stride)
